...
/* Offsets en la gdt */
/* -------------------------------------------------------------------------- */
#define GDT_OFF_NULL_DESC (GDT_IDX_NULL_DESC << 3) // 0
#define GDT_OFF_VIDEO  (GDT_IDX_VIDEO << 3)       // 40
...
#define GDT_CODE_3_SEL ((GDT_IDX_CODE_3 << 3) | 0b0000000000000011)
#define GDT_DATA_3_SEL ((GDT_IDX_DATA_3 << 3) | 0b0000000000000011)
//#define GDT_VID_SEL pato 
...
/* -------------------------------------------------------------------------- */
#define DESC_CODE_DATA          1     //pato
#define DESC_SYSTEM             0     //pato
#define DESC_TYPE_EXECUTE_READ  10  //0b1010 pato
#define DESC_TYPE_READ_WRITE    2  //0b0010 pato

// PATO hacemos macros de todos los atributos? dpl, s, p ...

/* COMPLETAR - Tamaños de segmentos */ 
#define FLAT_SEGM_SIZE  0x33100000                    //<-- 817 MiB en hexa// patisimo || 0xFFFF_FFFF 
#define FLAT_SEGV_SIZE  0x1F40   //50*80*2 8000 bytes
...
#define VIRT_PAGE_TABLE(X)  ((X & 0x3FF000) >> 12)
...
#define MMU_P (1 << 0)  // Presente
#define MMU_W (1 << 1)  // Escritura
#define MMU_U (1 << 2)  // modo User
